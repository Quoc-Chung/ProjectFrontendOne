...
const ShareButton: React.FC<ShareButtonProps> = ({ postId, onShare }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-800">Chia sẻ bài viết</h3>
              <button
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-medium text-gray-800">Sao chép link</p>
                  <p className="text-sm text-gray-500">Chia sẻ link bài viết</p>
                </div>
              </button>
