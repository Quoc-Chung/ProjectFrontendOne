...
const FloatingChatButton = () => {
  const { isOpen, openChatAIModal, closeChatAIModal } = useChatAIModalContext();
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[99999]">
      ...
      <button
        ...
        className={`group relative w-16 h-16 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 ${
          isOpen ? 'bg-red-500' : 'bg-blue'
        }`}
        title={isOpen ? "Đóng chat" : "Chat với AI Assistant"}
      >
        {/* Main button content */}
        ...
        {/* Notification badge - chỉ hiển thị khi modal đóng */}
        {!isOpen && (
